        ...
        <>
            ...
            {menuOpen && (
                <div className="fixed inset-0 z-40 md:hidden">
                    ...
                    {/* Menu Content */}
                    <div className={`absolute top-16 left-0 right-0 bottom-0 overflow-y-auto transition-all duration-300 ${
                        darkMode
                            ? 'bg-gray-900/95 text-white'
                            : 'bg-white/95 text-gray-900'
                    }`}>
                        <div className="p-4 pb-8">
                            <div className={`rounded-2xl p-4 backdrop-blur-sm border transition-all duration-300 ${
                                darkMode
