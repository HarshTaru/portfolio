...
const Navbar = () => {
    ...
    // Close the mobile menu once the viewport is wide enough for the desktop nav.
    // Must match the `lg:` breakpoint used for the nav layout below.
    useEffect(() => {
        ...
        <>
            ...
            >
                <div className="max-w-7xl mx-auto px-4 sm:px-6">
                    <div className="flex justify-between gap-2 h-16 items-center">

                        {/* Logo - Always visible */}
                        <a
                            href="#"
                            className="group flex shrink-0 items-center gap-2 text-base sm:text-lg xl:text-xl font-bold tracking-tight transition-all duration-300 hover:scale-105"
                        >
                            ...
                            <span className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-transparent bg-clip-text whitespace-nowrap">
                                Harsh Taru
                            </span>
                        </a>

                        {/* Desktop Navigation - links are compact at lg, full width at xl */}
                        <div className="hidden lg:flex items-center gap-1 xl:gap-2">
                            {navLinks.map((link) => (
                                <a
                                    ...
                                    className={`relative flex items-center gap-1.5 px-2.5 xl:px-4 py-2 rounded-full text-sm font-medium whitespace-nowrap transition-all duration-300 group ${
                                ...
                                >
                                    <span className="hidden xl:inline text-xs group-hover:scale-110 transition-transform duration-200">
                                        {link.icon}
                                    </span>
                                    {link.label}
                            ...
                            <button
                                ...
                                className={`group relative flex items-center gap-2 px-3 xl:px-4 py-2 rounded-full text-sm font-medium whitespace-nowrap transition-all duration-300 hover:scale-105 border-2 ${
                            ...
                            <button
                                onClick={toggleTheme}
                                className={`group relative flex items-center gap-2 px-3 xl:px-4 py-2 rounded-full border-2 transition-all duration-500 hover:scale-105 ${
                                    darkMode
            ...
            {menuOpen && (
                <div id="mobile-menu" className="fixed inset-0 z-40 lg:hidden">
                    ...
                    {/* Menu Content */}
                    <div className={`absolute top-16 left-0 right-0 bottom-0 overflow-y-auto overscroll-contain ${
                        darkMode
                        ...
                        <div className="p-4 pb-8">
                            <div className={`rounded-2xl p-4 backdrop-blur-sm border ${
                                ...
                                {/* Two columns once there is room for them (landscape phones, tablets) */}
                                ...
                                <div className={`my-3 border-t ${darkMode ? 'border-gray-700/50' : 'border-gray-200/50'}`}></div>
                                <button
                                    onClick={downloadResume}
                                    disabled={downloadStatus === 'downloading'}
